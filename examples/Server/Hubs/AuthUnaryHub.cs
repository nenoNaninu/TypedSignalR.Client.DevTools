...
[Authorize]
public class AuthUnaryHub : Hub<IAuthUnaryHubReceiver>, IAuthUnaryHub
{
    private readonly ILogger<AuthUnaryHub> _logger;

    public AuthUnaryHub(ILogger<AuthUnaryHub> logger)
    {
        _logger = logger;
    }
